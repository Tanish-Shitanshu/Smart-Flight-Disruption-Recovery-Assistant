...
st.markdown(
    ...
    <div class="github-button">
        <a href="https://github.com/Tanish-Shitanshu/Smart-Flight-Disruption-Recovery-Assistant" target="_blank">
            <button>
...
def main():
    ...
    <a href='https://github.com/Tanish-Shitanshu/Smart-Flight-Disruption-Recovery-Assistant'
       style='color: gray;' target='_blank'>GitHub</a>
